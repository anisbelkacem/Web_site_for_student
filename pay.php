        ...
        <form action="">
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <h3 class="title">Pour Passer en <span class="premium">PREMIUM</span></h3>
                    ...
                    <div class="inputBox">
                        ...
                        <input type="email" placeholder="xxxxxxx@exemple.com">
                    </div>
                    <div class="inputBox">
                        <span>Adresse :</span>
                        <input type="text" placeholder="Avenue - Localisation">
                    </div>
                    <div class="inputBox">
                        <span>Ville : </span>
                        <input type="text" placeholder="Tunis">
                    </div>
                ...
                <div class="col">
                    ...
                    <div class="inputBox">
                        ...
                        <input type="text" placeholder="mr. xxxx xxx">
                    </div>
                    <div class="inputBox">
                        <span>Nombre de la Carte :</span>
            ...
            <input type="submit" value="Continuer le Check" class="submit-btn">
      ...
      <div class="row">
        ...
        <div class="footer-col">
          ...
          <ul>
            ...
            <li><a href="pay.html">Passer en Premium</a></li>
